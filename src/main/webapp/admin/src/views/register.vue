      ...
      <div class="login-form">
		...
		<el-form ref="rgsForm" class="rgs-form" :model="rgsForm">
			...
			<!-- <div v-if="tableName=='yonghu'" class="input-group">
			   ...
			   <div class="input-container">
			     <input v-model="ruleForm.jinjilianxiren" class="input" type="text" placeholder="紧急联系人">
			   </div>
			 </div> -->
			<el-form-item label="紧急联系人" class="input" v-if="tableName=='yonghu'">
			  <el-input v-model="ruleForm.jinjilianxiren" autocomplete="off" placeholder="紧急联系人"  />
			</el-form-item>
			<!-- <div v-if="tableName=='yonghu'" class="input-group">
			...
			<el-form-item label="血型" class="input" v-if="tableName=='yonghu'">
			  <el-input v-model="ruleForm.xuexing" autocomplete="off" placeholder="血型"  />
			</el-form-item>
			<!-- <div v-if="tableName=='yonghu'" class="input-group">
			   <div class="label">禁忌</div>
			   <div class="input-container">
			     <input v-model="ruleForm.jinji" class="input" type="text" placeholder="禁忌">
			   </div>
			 </div> -->
			<el-form-item label="禁忌" class="input" v-if="tableName=='yonghu'">
			  <el-input v-model="ruleForm.jinji" autocomplete="off" placeholder="禁忌"  />
			</el-form-item>
...
export default {
  ...
  methods: {
	...
	var url=this.tableName+"/register";
      ...
      if(`yonghu` == this.tableName && this.ruleForm.jinjilianxiren&&(!this.$validate.isMobile(this.ruleForm.jinjilianxiren))){
