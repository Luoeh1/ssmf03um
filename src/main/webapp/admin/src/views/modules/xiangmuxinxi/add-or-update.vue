<template>
  <div class="addEdit-block">
    ...
    >
      <el-row >
        <el-col :span="12">
          <el-form-item class="input" v-if="type!='info'" label="诊疗编号" prop="xiangmubianhao">
            <el-input v-model="ruleForm.xiangmubianhao"
                      placeholder="诊疗编号" readonly></el-input>
          </el-form-item>
          <div v-else>
            <el-form-item class="input" v-if="ruleForm.xiangmubianhao" label="诊疗编号" prop="xiangmubianhao">
              <el-input v-model="ruleForm.xiangmubianhao"
                        placeholder="诊疗编号" readonly></el-input>
            </el-form-item>
          </div>
        ...
        <el-col :span="12">
          <el-form-item class="input" v-if="type!='info'"  label="诊疗名称" prop="xiangmumingcheng">
            <el-input v-model="ruleForm.xiangmumingcheng"
                      placeholder="诊疗名称" clearable  :readonly="ro.xiangmumingcheng"></el-input>
          </el-form-item>
          <div v-else>
            <el-form-item class="input" label="诊疗名称" prop="xiangmumingcheng">
              <el-input v-model="ruleForm.xiangmumingcheng"
                        placeholder="诊疗名称" readonly></el-input>
            </el-form-item>
          </div>
        </el-col>
        <el-col :span="12">
          ...
          <div v-else>
            <el-form-item class="input" label="诊疗分类" prop="xiangmufenlei">
              <el-input v-model="ruleForm.xiangmufenlei"
                        placeholder="诊疗分类" readonly></el-input>
            </el-form-item>
          </div>
        </el-col>
        <el-col :span="24">
        ...
        <el-col :span="12">
          <el-form-item class="input" v-if="type!='info'"  label="诊疗位置" prop="xiangmuweizhi">
            <el-input v-model="ruleForm.xiangmuweizhi"
                      placeholder="诊疗位置" clearable  :readonly="ro.xiangmuweizhi"></el-input>
          </el-form-item>
          <div v-else>
            <el-form-item class="input" label="诊疗位置" prop="xiangmuweizhi">
              <el-input v-model="ruleForm.xiangmuweizhi"
                        placeholder="诊疗位置" readonly></el-input>
            </el-form-item>
          </div>
        </el-col>
        ...
        <el-col :span="12">
          <el-form-item class="input" v-if="type!='info'"  label="医生姓名" prop="yishengxingming">
            <el-input v-model="ruleForm.yishengxingming"
                      placeholder="选择医生后自动带出" readonly></el-input>
          </el-form-item>
          <div v-else>
      ...
      <el-row>
        <el-col :span="24">
          <el-form-item class="textarea" v-if="type!='info'" label="诊疗介绍" prop="xiangmujieshao">
            <el-input
          ...
          <div v-else>
            <el-form-item v-if="ruleForm.xiangmujieshao" label="诊疗介绍" prop="xiangmujieshao">
...
export default {
  data() {
    ...
    return {
      ...
      rules: {
        xiangmubianhao: [],
        xiangmumingcheng: [
          { required: true, message: '诊疗名称不能为空', trigger: 'blur' },
        ],
        xiangmufenlei: [],
        tupian: [
  ...
  methods: {
    ...
    yishenggonghaoChange(val) {
      ...
      if (doc) {
        // 瞬间填入该医生的名字
        this.ruleForm.yishengxingming = doc.yishengxingming;
      }
    },
