    ...
    <div class="login-card">
      ...
      <div class="login-right">
        ...
        <el-form class="custom-login-form" ref="rulesForm" :model="rulesForm">
          ...
          <div class="front-link-container">
            <a href="javascript:void(0)" @click="goToFront()" class="front-login-link">
              <i class="el-icon-back"></i> 返回普通用户端
            </a>
          </div>
...
export default {
  ...
  methods: {
    // 新增：跳转回前台登录页或主页的方法
    goToFront() {
      // this.baseUrl 通常解析为 /ssmf03um/，所以这里拼接前台的路径
      window.location.href = `${this.baseUrl}front/pages/login/login.html`;
    },
...
.front-login-link:hover {
  color: #008476;
  text-decoration: underline;
  transform: translateX(-3px); /* 悬停时会有一个轻微向左移动的互动效果 */
}
