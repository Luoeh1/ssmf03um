<template>
  <div class="addEdit-block">
    ...
    >
      <el-row >
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="公告标题" prop="title">
          <el-input v-model="ruleForm.title" 
              placeholder="标题" clearable  :readonly="ro.title"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="公告标题" prop="title">
              <el-input v-model="ruleForm.title" 
      ...
      <el-col :span="24">  
        <el-form-item class="upload" v-if="type!='info' && !ro.picture" label="公告图片" prop="picture">
          <file-upload
          tip="点击上传公告图片"
          action="file/upload"
          :limit="3"
        ...
        <div v-else>
          <el-form-item v-if="ruleForm.picture" label="公告图片" prop="picture">
          ...
          <el-row>
            <el-col :span="24">
              <el-form-item class="textarea" v-if="type!='info'" label="公告简介" prop="introduction">
                <el-input
              ...
              <div v-else>
                <el-form-item v-if="ruleForm.introduction" label="公告简介" prop="introduction">
